...
OptaPlannerは、link:http://www.apache.org/licenses/LICENSE-2.0.html[Apache ソフトウェアライセンス 2.0]の下で配布される _オープンソース・ソフトウェア_ です。このライセンスは、非常に進歩的で、商用目的での再使用を許容しています。link:http://www.apache.org/foundation/license-faq.html#WhatDoesItMEAN[一般向け説明]に目を通してください。

...
Red Hat は、中核チームを雇用する形で、OptaPlanner の展開を支援しています。企業向けのサポートやコンサルティングについては、link:http://www.optaplanner.org/community/product.html[BRMS および BPMS 製品] (含 OptaPlanner) を参照するか、link:http://www.redhat.com/en/about/contact/sales[Red Hat へお問い合わせ]ください。
